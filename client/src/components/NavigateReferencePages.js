...
const NavigateReferencePages = () => {
  ...
  const lastPage = Math.ceil(totalReference / referencePerPage);
      ...
      <ul className="pagination">
        ...
        <li
          className={`page-item ${
            ...
            currentPage === 1
              ? totalReference <= referencePerPage
                ? ' disabled'
                : ' active'
              : ''
          }`}
...
export default NavigateReferencePages;
